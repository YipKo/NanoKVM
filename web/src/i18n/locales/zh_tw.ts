    ...
    settings: {
      ...
      network: {
        ...
        wifi: {
          ...
          ipConfig: 'IP 設定',
          ipConfigDescription: '為此 Wi-Fi 連線選擇 DHCP 或設定靜態位址',
          ...
          security: '安全性',
          personal: '個人 / WPA-PSK',
          enterprise: '企業 / 802.1X',
          identity: '身分 / 使用者名稱',
          authentication: '認證方式',
          innerAuthentication: '內部認證',
          anonymousIdentity: '匿名身分（選填）',
          caCert: 'CA 憑證路徑（選填）',
          domainSuffixMatch: '網域後綴比對（選填）',
          clientCert: '用戶端憑證路徑',
          privateKey: '私鑰路徑',
          privateKeyPasswd: '私鑰密碼（選填）',
          eapPeap: '受保護的 EAP (PEAP)',
          eapTtls: '通道 TLS (TTLS)',
          eapTls: 'TLS（憑證）',
          eapPwd: 'PWD',
          eapLeap: 'LEAP',
        ...
        ethernet: {
          title: '有線網路',
          description: '設定 IP 資訊與可選的 802.1X 驗證',
          connect: '設定有線網路',
          connectDesc: '為 {{iface}} 設定 IP 資訊，並在需要時啟用 802.1X 驗證',
          ipConfig: 'IP 設定',
          ipConfigDescription: '為此有線介面選擇 DHCP 或設定靜態位址',
          authTitle: '802.1X 驗證',
          authDescription: '僅在你的有線網路需要使用者名稱、密碼或憑證驗證時啟用',
          addressPlaceholder: '靜態 IP 位址（例如 192.168.1.10）',
          gatewayPlaceholder: '閘道（可選）',
          passwordUnchanged: '不變更',
          privateKeyPasswdUnchanged: '不變更',
          off: '已停用',
          enterprise: '企業 / 802.1X',
          active: '802.1X 已啟用',
          inactive: '802.1X 已設定，等待驗證',
          failed: '設定有線網路 802.1X 失敗，請重試。'
        },
        tls: {

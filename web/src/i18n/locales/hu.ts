    ...
    settings: {
      ...
      network: {
        ...
        wifi: {
          ...
          confirmBtn: 'OK',
          cancelBtn: 'Mégse',
          ipConfig: 'IP konfiguráció',
          ipConfigDescription: 'Válassza a DHCP-t vagy állítson be statikus címet ehhez a Wi-Fi kapcsolathoz',
          security: 'Biztonság',
          personal: 'Személyes / WPA-PSK',
          enterprise: 'Vállalati / 802.1X',
          identity: 'Azonosító / Felhasználónév',
          authentication: 'Hitelesítés',
          innerAuthentication: 'Belső hitelesítés',
          anonymousIdentity: 'Névtelen azonosító (opcionális)',
          caCert: 'CA tanúsítvány elérési útja (opcionális)',
          domainSuffixMatch: 'Tartomány utótag egyezés (opcionális)',
          clientCert: 'Kliens tanúsítvány elérési útja',
          privateKey: 'Privát kulcs elérési útja',
          privateKeyPasswd: 'Privát kulcs jelszava (opcionális)',
          eapPeap: 'Protected EAP (PEAP)',
          eapTtls: 'Tunneled TLS (TTLS)',
          eapTls: 'TLS (Tanúsítvány)',
          eapPwd: 'PWD',
          eapLeap: 'LEAP',
        ...
        ethernet: {
          title: 'Vezetékes hálózat',
          description: 'IP beállítások és opcionális 802.1X hitelesítés konfigurálása',
          connect: 'Vezetékes hálózat konfigurálása',
          connectDesc: 'IP konfiguráció beállítása a(z) {{iface}} számára és 802.1X engedélyezése szükség esetén',
          ipConfig: 'IP konfiguráció',
          ipConfigDescription: 'Válassza a DHCP-t vagy állítson be statikus címet ehhez a vezetékes interfészhez',
          authTitle: '802.1X hitelesítés',
          authDescription: 'Csak akkor engedélyezze, ha a vezetékes hálózat felhasználónévvel, jelszóval vagy tanúsítvánnyal történő hitelesítést igényel',
          driverRequired: 'A vezetékes 802.1X egy wired meghajtó támogatással rendelkező rendszer wpa_supplicant-t igényel',
          addressPlaceholder: 'Statikus IP-cím (pl. 192.168.1.10)',
          gatewayPlaceholder: 'Átjáró (opcionális)',
          passwordUnchanged: 'Nincs változás',
          privateKeyPasswdUnchanged: 'Nincs változás',
          off: 'Letiltva',
          enterprise: 'Vállalati / 802.1X',
          active: '802.1X engedélyezve',
          inactive: '802.1X konfigurálva, hitelesítésre vár',
          failed: 'A vezetékes hálózat 802.1X konfigurálása sikertelen. Kérjük, próbálja újra.'
        },

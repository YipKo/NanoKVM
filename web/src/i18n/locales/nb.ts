    ...
    settings: {
      ...
      network: {
        ...
        wifi: {
          ...
          confirmBtn: 'OK',
          cancelBtn: 'Avbryt',
          ipConfig: 'IP-konfigurasjon',
          ipConfigDescription: 'Velg DHCP eller angi en statisk adresse for denne Wi-Fi-tilkoblingen',
          security: 'Sikkerhet',
          personal: 'Personlig / WPA-PSK',
          enterprise: 'Bedrift / 802.1X',
          identity: 'Identitet / Brukernavn',
          authentication: 'Autentisering',
          innerAuthentication: 'Indre autentisering',
          anonymousIdentity: 'Anonym identitet (valgfritt)',
          caCert: 'CA-sertifikatsti (valgfritt)',
          domainSuffixMatch: 'Domene suffiks-samsvar (valgfritt)',
          clientCert: 'Klientsertifikatsti',
          privateKey: 'Privat nøkkelsti',
          privateKeyPasswd: 'Passord for privat nøkkel (valgfritt)',
          eapPeap: 'Protected EAP (PEAP)',
          eapTtls: 'Tunneled TLS (TTLS)',
          eapTls: 'TLS (Sertifikat)',
          eapPwd: 'PWD',
          eapLeap: 'LEAP',
        ...
        ethernet: {
          title: 'Kablet nettverk',
          description: 'Konfigurer IP-innstillinger og valgfri 802.1X-autentisering',
          connect: 'Konfigurer kablet nettverk',
          connectDesc: 'Konfigurer IP for {{iface}} og aktiver 802.1X ved behov',
          ipConfig: 'IP-konfigurasjon',
          ipConfigDescription: 'Velg DHCP eller angi en statisk adresse for dette kablede grensesnittet',
          authTitle: '802.1X-autentisering',
          authDescription: 'Aktiver bare hvis ditt kablede nettverk krever brukernavn, passord eller sertifikat-autentisering',
          driverRequired: 'Kablet 802.1X krever en system-wpa_supplicant med støtte for wired-driver',
          addressPlaceholder: 'Statisk IP-adresse (f.eks. 192.168.1.10)',
          gatewayPlaceholder: 'Gateway (valgfritt)',
          passwordUnchanged: 'Ingen endring',
          privateKeyPasswdUnchanged: 'Ingen endring',
          off: 'Deaktivert',
          enterprise: 'Bedrift / 802.1X',
          active: '802.1X aktivert',
          inactive: '802.1X konfigurert, venter på autentisering',
          failed: 'Konfigurasjon av kablet nettverk 802.1X mislyktes. Vennligst prøv igjen.'
        },

    ...
    settings: {
      ...
      network: {
        ...
        wifi: {
          ...
          ipConfigDescription: 'Vælg DHCP eller angiv en statisk adresse for denne Wi-Fi-forbindelse',
          security: 'Sikkerhed',
          personal: 'Personlig / WPA-PSK',
          enterprise: 'Erhverv / 802.1X',
          identity: 'Identitet / Brugernavn',
          authentication: 'Godkendelse',
          innerAuthentication: 'Intern godkendelse',
          anonymousIdentity: 'Anonym identitet (valgfrit)',
          caCert: 'CA-certifikatsti (valgfrit)',
          domainSuffixMatch: 'Domænesuffiks-matchning (valgfrit)',
          clientCert: 'Klientcertifikatsti',
          privateKey: 'Privat nøglesti',
          privateKeyPasswd: 'Adgangskode for privat nøgle (valgfrit)',
          eapPeap: 'Protected EAP (PEAP)',
          eapTtls: 'Tunneled TLS (TTLS)',
          eapTls: 'TLS (Certifikat)',
          eapPwd: 'PWD',
          eapLeap: 'LEAP',
        ...
        ethernet: {
          title: 'Kablet netværk',
          description: 'Konfigurer IP-indstillinger og valgfri 802.1X-godkendelse',
          connect: 'Konfigurer kablet netværk',
          connectDesc: 'Konfigurer IP for {{iface}} og aktiver 802.1X ved behov',
          ipConfig: 'IP-konfiguration',
          ipConfigDescription: 'Vælg DHCP eller angiv en statisk adresse for dette kablede interface',
          authTitle: '802.1X-godkendelse',
          authDescription: 'Aktiver kun hvis dit kablede netværk kræver brugernavn, adgangskode eller certifikatgodkendelse',
          driverRequired: 'Kablet 802.1X kræver en system-wpa_supplicant med understøttelse af wired-driver',
          addressPlaceholder: 'Statisk IP-adresse (f.eks. 192.168.1.10)',
          gatewayPlaceholder: 'Gateway (valgfrit)',
          passwordUnchanged: 'Ingen ændring',
          privateKeyPasswdUnchanged: 'Ingen ændring',
          off: 'Deaktiveret',
          enterprise: 'Erhverv / 802.1X',
          active: '802.1X aktiveret',
          inactive: '802.1X konfigureret, venter på godkendelse',
          failed: 'Konfiguration af kablet netværk 802.1X mislykkedes. Prøv venligst igen.'
        },
        ...
        dns: {
          ...
          rxRate: 'Modtagelseshastighed',
          txRate: 'Sendehastighed',
          none: 'Ingen'
        },

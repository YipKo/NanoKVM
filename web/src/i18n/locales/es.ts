    ...
    settings: {
      ...
      network: {
        ...
        wifi: {
          ...
          ipConfigDescription: 'Elegir DHCP o establecer una dirección estática para esta conexión Wi-Fi',
          security: 'Seguridad',
          personal: 'Personal / WPA-PSK',
          enterprise: 'Empresa / 802.1X',
          identity: 'Identidad / Nombre de usuario',
          authentication: 'Autenticación',
          innerAuthentication: 'Autenticación interna',
          anonymousIdentity: 'Identidad anónima (opcional)',
          caCert: 'Ruta del certificado CA (opcional)',
          domainSuffixMatch: 'Coincidencia de sufijo de dominio (opcional)',
          clientCert: 'Ruta del certificado cliente',
          privateKey: 'Ruta de la clave privada',
          privateKeyPasswd: 'Contraseña de la clave privada (opcional)',
          eapPeap: 'Protected EAP (PEAP)',
          eapTtls: 'Tunneled TLS (TTLS)',
          eapTls: 'TLS (Certificado)',
          eapPwd: 'PWD',
          eapLeap: 'LEAP',
        ...
        ethernet: {
          title: 'Red cableada',
          description: 'Configurar IP y autenticación 802.1X opcional',
          connect: 'Configurar red cableada',
          connectDesc: 'Configurar IP para {{iface}} y habilitar 802.1X si es necesario',
          ipConfig: 'Configuración IP',
          ipConfigDescription: 'Elegir DHCP o establecer una dirección estática para esta interfaz cableada',
          authTitle: 'Autenticación 802.1X',
          authDescription: 'Active solo si su red cableada requiere autenticación por usuario, contraseña o certificado',
          driverRequired: '802.1X cableado necesita un wpa_supplicant del sistema con soporte de controlador wired',
          addressPlaceholder: 'Dirección IP estática (ej: 192.168.1.10)',
          gatewayPlaceholder: 'Puerta de enlace (opcional)',
          passwordUnchanged: 'Sin cambios',
          privateKeyPasswdUnchanged: 'Sin cambios',
          off: 'Deshabilitado',
          enterprise: 'Empresa / 802.1X',
          active: '802.1X habilitado',
          inactive: '802.1X configurado, esperando autenticación',
          failed: 'Error al configurar la red cableada 802.1X. Por favor, inténtelo de nuevo.'
        },

    ...
    settings: {
      ...
      network: {
        ...
        wifi: {
          ...
          confirmBtn: 'OK',
          cancelBtn: 'Batal',
          ipConfig: 'Konfigurasi IP',
          ipConfigDescription: 'Pilih DHCP atau atur alamat statis untuk koneksi Wi-Fi ini',
          security: 'Keamanan',
          personal: 'Personal / WPA-PSK',
          enterprise: 'Enterprise / 802.1X',
          identity: 'Identitas / Nama pengguna',
          authentication: 'Autentikasi',
          innerAuthentication: 'Autentikasi internal',
          anonymousIdentity: 'Identitas anonim (opsional)',
          caCert: 'Jalur sertifikat CA (opsional)',
          domainSuffixMatch: 'Pencocokan akhiran domain (opsional)',
          clientCert: 'Jalur sertifikat klien',
          privateKey: 'Jalur kunci privat',
          privateKeyPasswd: 'Kata sandi kunci privat (opsional)',
        ...
        ethernet: {
          title: 'Jaringan berkabel',
          description: 'Konfigurasi IP dan autentikasi 802.1X opsional',
          connect: 'Konfigurasi jaringan berkabel',
          connectDesc: 'Atur konfigurasi IP untuk {{iface}} dan aktifkan 802.1X jika diperlukan',
          ipConfig: 'Konfigurasi IP',
          ipConfigDescription: 'Pilih DHCP atau atur alamat statis untuk antarmuka berkabel ini',
          authTitle: 'Autentikasi 802.1X',
          authDescription: 'Aktifkan hanya jika jaringan berkabel Anda memerlukan autentikasi nama pengguna, kata sandi, atau sertifikat',
          driverRequired: '802.1X berkabel memerlukan build wpa_supplicant sistem dengan dukungan driver wired',
          addressPlaceholder: 'Alamat IP statis (mis: 192.168.1.10)',
          gatewayPlaceholder: 'Gateway (opsional)',
          passwordUnchanged: 'Tidak ada perubahan',
          privateKeyPasswdUnchanged: 'Tidak ada perubahan',
          off: 'Nonaktif',
          enterprise: 'Enterprise / 802.1X',
          active: '802.1X aktif',
          inactive: '802.1X dikonfigurasi, menunggu autentikasi',
          failed: 'Gagal mengkonfigurasi jaringan berkabel 802.1X. Silakan coba lagi.'
        },

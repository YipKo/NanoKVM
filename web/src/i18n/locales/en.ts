    ...
    settings: {
      ...
      network: {
        ...
        wifi: {
          ...
          ipConfigDescription: 'Choose DHCP or set a static address for this Wi-Fi connection',
          ...
          innerAuthentication: 'Inner authentication',
          anonymousIdentity: 'Anonymous identity (optional)',
          caCert: 'CA certificate path (optional)',
          domainSuffixMatch: 'Domain suffix match (optional)',
          clientCert: 'Client certificate path',
          privateKey: 'Private key path',
          privateKeyPasswd: 'Private key password (optional)',
          eapPeap: 'Protected EAP (PEAP)',
          eapTtls: 'Tunneled TLS (TTLS)',
          eapTls: 'TLS (Certificate)',
          eapPwd: 'PWD',
          eapLeap: 'LEAP',
        ...
        ethernet: {
          title: 'Ethernet',
          description: 'Configure IP settings and optional 802.1X authentication',
          connect: 'Configure Ethernet',
          connectDesc: 'Set IP configuration for {{iface}} and enable 802.1X if your network requires it',
          ipConfig: 'IP configuration',
          ipConfigDescription: 'Choose DHCP or set a static address for this wired interface',
          authTitle: '802.1X authentication',
          authDescription: 'Enable this only if your wired network requires username, password, or certificate authentication',
          addressPlaceholder: 'Static IP address (e.g. 192.168.1.10)',
          gatewayPlaceholder: 'Gateway (optional)',
          passwordUnchanged: 'No change',
          privateKeyPasswdUnchanged: 'No change',
          off: 'Disabled',
          enterprise: 'Enterprise / 802.1X',
          active: '802.1X enabled',
          inactive: '802.1X configured, waiting for authentication',
          failed: 'Failed to configure Ethernet 802.1X, please try again.'
        },
        tls: {

    ...
    settings: {
      ...
      network: {
        ...
        wifi: {
          ...
          ipConfigDescription: 'Scegli DHCP o imposta un indirizzo statico per questa connessione Wi-Fi',
          security: 'Sicurezza',
          personal: 'Personale / WPA-PSK',
          enterprise: 'Aziendale / 802.1X',
          identity: 'Identità / Nome utente',
          authentication: 'Autenticazione',
          innerAuthentication: 'Autenticazione interna',
          anonymousIdentity: 'Identità anonima (opzionale)',
          caCert: 'Percorso certificato CA (opzionale)',
          domainSuffixMatch: 'Corrispondenza suffisso dominio (opzionale)',
          clientCert: 'Percorso certificato client',
          privateKey: 'Percorso chiave privata',
          privateKeyPasswd: 'Password chiave privata (opzionale)',
          eapPeap: 'Protected EAP (PEAP)',
          eapTtls: 'Tunneled TLS (TTLS)',
          eapTls: 'TLS (Certificato)',
          eapPwd: 'PWD',
          eapLeap: 'LEAP',
        ...
        ethernet: {
          title: 'Rete cablata',
          description: 'Configura IP e autenticazione 802.1X opzionale',
          connect: 'Configura rete cablata',
          connectDesc: 'Configura IP per {{iface}} e abilita 802.1X se necessario',
          ipConfig: 'Configurazione IP',
          ipConfigDescription: 'Scegli DHCP o imposta un indirizzo statico per questa interfaccia cablata',
          authTitle: 'Autenticazione 802.1X',
          authDescription: 'Abilita solo se la rete cablata richiede autenticazione tramite nome utente, password o certificato',
          driverRequired: '802.1X cablato richiede un wpa_supplicant di sistema con supporto driver wired',
          addressPlaceholder: 'Indirizzo IP statico (es: 192.168.1.10)',
          gatewayPlaceholder: 'Gateway (opzionale)',
          passwordUnchanged: 'Nessuna modifica',
          privateKeyPasswdUnchanged: 'Nessuna modifica',
          off: 'Disabilitato',
          enterprise: 'Aziendale / 802.1X',
          active: '802.1X abilitato',
          inactive: '802.1X configurato, in attesa di autenticazione',
          failed: 'Configurazione della rete cablata 802.1X non riuscita. Riprova.'
        },
        ...
        dns: {
          ...
          rxRate: 'Velocità ricezione',
          txRate: 'Velocità trasmissione',
          none: 'Nessuno'
        },

    ...
    settings: {
      ...
      network: {
        ...
        wifi: {
          ...
          ipConfigDescription: 'Escolher DHCP ou definir um endereço estático para esta conexão Wi-Fi',
          security: 'Segurança',
          personal: 'Pessoal / WPA-PSK',
          enterprise: 'Empresarial / 802.1X',
          identity: 'Identidade / Nome de usuário',
          authentication: 'Autenticação',
          innerAuthentication: 'Autenticação interna',
          anonymousIdentity: 'Identidade anônima (opcional)',
          caCert: 'Caminho do certificado CA (opcional)',
          domainSuffixMatch: 'Correspondência de sufixo de domínio (opcional)',
          clientCert: 'Caminho do certificado cliente',
          privateKey: 'Caminho da chave privada',
          privateKeyPasswd: 'Senha da chave privada (opcional)',
        ...
        ethernet: {
          title: 'Rede cabeada',
          description: 'Configurar IP e autenticação 802.1X opcional',
          connect: 'Configurar rede cabeada',
          connectDesc: 'Configurar IP para {{iface}} e habilitar 802.1X se necessário',
          ipConfig: 'Configuração de IP',
          ipConfigDescription: 'Escolher DHCP ou definir um endereço estático para esta interface cabeada',
          authTitle: 'Autenticação 802.1X',
          authDescription: 'Ative apenas se sua rede cabeada exigir autenticação por usuário, senha ou certificado',
          driverRequired: '802.1X cabeado requer um wpa_supplicant do sistema com suporte ao driver wired',
          addressPlaceholder: 'Endereço IP estático (ex: 192.168.1.10)',
          gatewayPlaceholder: 'Gateway (opcional)',
          passwordUnchanged: 'Sem alteração',
          privateKeyPasswdUnchanged: 'Sem alteração',
          off: 'Desabilitado',
          enterprise: 'Empresarial / 802.1X',
          active: '802.1X habilitado',
          inactive: '802.1X configurado, aguardando autenticação',
          failed: 'Falha ao configurar a rede cabeada 802.1X. Por favor, tente novamente.'
        },

    ...
    settings: {
      ...
      network: {
        ...
        wifi: {
          ...
          ipConfigDescription: 'Bu Wi-Fi bağlantısı için DHCP seçin veya statik adres ayarlayın',
          security: 'Güvenlik',
          personal: 'Kişisel / WPA-PSK',
          enterprise: 'Kurumsal / 802.1X',
          identity: 'Kimlik / Kullanıcı adı',
          authentication: 'Kimlik doğrulama',
          innerAuthentication: 'Dahili kimlik doğrulama',
          anonymousIdentity: 'Anonim kimlik (isteğe bağlı)',
          caCert: 'CA sertifika yolu (isteğe bağlı)',
          domainSuffixMatch: 'Alan adı son ek eşleşmesi (isteğe bağlı)',
          clientCert: 'İstemci sertifika yolu',
          privateKey: 'Özel anahtar yolu',
          privateKeyPasswd: 'Özel anahtar şifresi (isteğe bağlı)',
          eapPeap: 'Protected EAP (PEAP)',
          eapTtls: 'Tunneled TLS (TTLS)',
          eapTls: 'TLS (Sertifika)',
          eapPwd: 'PWD',
          eapLeap: 'LEAP',
        ...
        ethernet: {
          title: 'Kablolu ağ',
          description: 'IP ayarları ve isteğe bağlı 802.1X kimlik doğrulaması yapılandırması',
          connect: 'Kablolu ağı yapılandır',
          connectDesc: '{{iface}} için IP yapılandırmasını ayarlayın ve gerekirse 802.1X kimlik doğrulamasını etkinleştirin',
          ipConfig: 'IP yapılandırması',
          ipConfigDescription: 'Bu kablolu arayüz için DHCP seçin veya statik adres ayarlayın',
          authTitle: '802.1X kimlik doğrulama',
          authDescription: 'Yalnızca kablolu ağınız kullanıcı adı, şifre veya sertifika kimlik doğrulaması gerektiriyorsa etkinleştirin',
          driverRequired: 'Kablolu 802.1X, wired sürücü desteğine sahip bir sistem wpa_supplicant derlemesi gerektirir',
          addressPlaceholder: 'Statik IP adresi (örn: 192.168.1.10)',
          gatewayPlaceholder: 'Ağ geçidi (isteğe bağlı)',
          passwordUnchanged: 'Değişiklik yok',
          privateKeyPasswdUnchanged: 'Değişiklik yok',
          off: 'Devre dışı',
          enterprise: 'Kurumsal / 802.1X',
          active: '802.1X etkin',
          inactive: '802.1X yapılandırıldı, kimlik doğrulama bekleniyor',
          failed: 'Kablolu ağ 802.1X yapılandırması başarısız oldu. Lütfen tekrar deneyin.'
        },

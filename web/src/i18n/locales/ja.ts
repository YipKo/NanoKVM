    ...
    settings: {
      ...
      network: {
        ...
        wifi: {
          ...
          cancelBtn: 'キャンセル',
          ipConfig: 'IP 設定',
          ipConfigDescription: 'この Wi-Fi 接続に DHCP または静的アドレスを設定',
          security: 'セキュリティ',
          personal: 'パーソナル / WPA-PSK',
          enterprise: 'エンタープライズ / 802.1X',
          identity: 'ID / ユーザー名',
          authentication: '認証方式',
          innerAuthentication: '内部認証',
          anonymousIdentity: '匿名 ID（任意）',
          caCert: 'CA 証明書パス（任意）',
          domainSuffixMatch: 'ドメインサフィックスマッチ（任意）',
          clientCert: 'クライアント証明書パス',
          privateKey: '秘密鍵パス',
          privateKeyPasswd: '秘密鍵パスワード（任意）',
        ...
        ethernet: {
          title: '有線ネットワーク',
          description: 'IP 設定とオプションの 802.1X 認証を設定',
          connect: '有線ネットワークを設定',
          connectDesc: '{{iface}} の IP 設定を行い、必要に応じて 802.1X 認証を有効にする',
          ipConfig: 'IP 設定',
          ipConfigDescription: 'この有線インターフェースに DHCP または静的アドレスを設定',
          authTitle: '802.1X 認証',
          authDescription: '有線ネットワークでユーザー名、パスワード、または証明書認証が必要な場合のみ有効にしてください',
          driverRequired: '有線 802.1X には、wired ドライバーをサポートする wpa_supplicant のシステムビルドが必要です',
          addressPlaceholder: '静的 IP アドレス（例: 192.168.1.10）',
          gatewayPlaceholder: 'ゲートウェイ（任意）',
          passwordUnchanged: '変更なし',
          privateKeyPasswdUnchanged: '変更なし',
          off: '無効',
          enterprise: 'エンタープライズ / 802.1X',
          active: '802.1X 有効',
          inactive: '802.1X 設定済み、認証待ち',
          failed: '有線ネットワーク 802.1X の設定に失敗しました。もう一度お試しください。'
        },

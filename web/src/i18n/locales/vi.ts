    ...
    settings: {
      ...
      network: {
        ...
        wifi: {
          ...
          ipConfigDescription: 'Chọn DHCP hoặc đặt địa chỉ tĩnh cho kết nối Wi-Fi này',
          security: 'Bảo mật',
          personal: 'Cá nhân / WPA-PSK',
          enterprise: 'Doanh nghiệp / 802.1X',
          identity: 'ID / Tên người dùng',
          authentication: 'Xác thực',
          innerAuthentication: 'Xác thực nội bộ',
          anonymousIdentity: 'ID ẩn danh (tùy chọn)',
          caCert: 'Đường dẫn chứng chỉ CA (tùy chọn)',
          domainSuffixMatch: 'Khớp hậu tố tên miền (tùy chọn)',
          clientCert: 'Đường dẫn chứng chỉ máy khách',
          privateKey: 'Đường dẫn khóa riêng',
          privateKeyPasswd: 'Mật khẩu khóa riêng (tùy chọn)',
          eapPeap: 'Protected EAP (PEAP)',
          eapTtls: 'Tunneled TLS (TTLS)',
          eapTls: 'TLS (Chứng chỉ)',
          eapPwd: 'PWD',
          eapLeap: 'LEAP',
        ...
        ethernet: {
          title: 'Mạng có dây',
          description: 'Cấu hình IP và xác thực 802.1X tùy chọn',
          connect: 'Cấu hình mạng có dây',
          connectDesc: 'Cấu hình IP cho {{iface}} và bật 802.1X nếu cần',
          ipConfig: 'Cấu hình IP',
          ipConfigDescription: 'Chọn DHCP hoặc đặt địa chỉ tĩnh cho giao diện có dây này',
          authTitle: 'Xác thực 802.1X',
          authDescription: 'Chỉ bật nếu mạng có dây của bạn yêu cầu xác thực bằng tên người dùng, mật khẩu hoặc chứng chỉ',
          driverRequired: 'Mạng có dây 802.1X cần wpa_supplicant với hỗ trợ trình điều khiển wired',
          addressPlaceholder: 'Địa chỉ IP tĩnh (vd: 192.168.1.10)',
          gatewayPlaceholder: 'Cổng mạng (tùy chọn)',
          passwordUnchanged: 'Không thay đổi',
          privateKeyPasswdUnchanged: 'Không thay đổi',
          off: 'Tắt',
          enterprise: 'Doanh nghiệp / 802.1X',
          active: '802.1X đã bật',
          inactive: '802.1X đã cấu hình, đang chờ xác thực',
          failed: 'Cấu hình mạng có dây 802.1X thất bại. Vui lòng thử lại.'
        },

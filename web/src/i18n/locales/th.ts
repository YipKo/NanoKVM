    ...
    settings: {
      ...
      network: {
        ...
        wifi: {
          ...
          confirmBtn: 'ตกลง',
          cancelBtn: 'ยกเลิก',
          ipConfig: 'กำหนดค่า IP',
          ipConfigDescription: 'เลือก DHCP หรือตั้งค่าที่อยู่แบบคงที่สำหรับการเชื่อมต่อ Wi-Fi นี้',
          security: 'ความปลอดภัย',
          personal: 'ส่วนบุคคล / WPA-PSK',
          enterprise: 'องค์กร / 802.1X',
          identity: 'ID / ชื่อผู้ใช้',
          authentication: 'การยืนยันตัวตน',
          innerAuthentication: 'การยืนยันตัวตนภายใน',
          anonymousIdentity: 'ID นิรนาม (ไม่บังคับ)',
          caCert: 'เส้นทางใบรับรอง CA (ไม่บังคับ)',
          domainSuffixMatch: 'การจับคู่นามสกุลโดเมน (ไม่บังคับ)',
          clientCert: 'เส้นทางใบรับรองไคลเอนต์',
          privateKey: 'เส้นทางกุญแจส่วนตัว',
          privateKeyPasswd: 'รหัสผ่านกุญแจส่วนตัว (ไม่บังคับ)',
        ...
        ethernet: {
          title: 'เครือข่ายแบบมีสาย',
          description: 'กำหนดค่า IP และการยืนยันตัวตน 802.1X แบบเลือกได้',
          connect: 'กำหนดค่าเครือข่ายแบบมีสาย',
          connectDesc: 'กำหนดค่า IP สำหรับ {{iface}} และเปิดใช้งาน 802.1X หากจำเป็น',
          ipConfig: 'กำหนดค่า IP',
          ipConfigDescription: 'เลือก DHCP หรือตั้งค่าที่อยู่แบบคงที่สำหรับอินเทอร์เฟซแบบมีสายนี้',
          authTitle: 'การยืนยันตัวตน 802.1X',
          authDescription: 'เปิดใช้งานเฉพาะเมื่อเครือข่ายแบบมีสายของคุณต้องการการยืนยันตัวตนด้วยชื่อผู้ใช้ รหัสผ่าน หรือใบรับรอง',
          driverRequired: 'เครือข่ายแบบมีสาย 802.1X ต้องการ wpa_supplicant ที่รองรับไดรเวอร์ wired',
          addressPlaceholder: 'ที่อยู่ IP แบบคงที่ (เช่น 192.168.1.10)',
          gatewayPlaceholder: 'เกตเวย์ (ไม่บังคับ)',
          passwordUnchanged: 'ไม่เปลี่ยนแปลง',
          privateKeyPasswdUnchanged: 'ไม่เปลี่ยนแปลง',
          off: 'ปิดใช้งาน',
          enterprise: 'องค์กร / 802.1X',
          active: '802.1X เปิดใช้งานแล้ว',
          inactive: '802.1X กำหนดค่าแล้ว รอการยืนยันตัวตน',
          failed: 'กำหนดค่าเครือข่ายแบบมีสาย 802.1X ล้มเหลว กรุณาลองใหม่'
        },

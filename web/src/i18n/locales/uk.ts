    ...
    settings: {
      ...
      network: {
        ...
        wifi: {
          ...
          confirmBtn: 'OK',
          cancelBtn: 'Скасувати',
          ipConfig: 'Налаштування IP',
          ipConfigDescription: 'Оберіть DHCP або встановіть статичну адресу для цього Wi-Fi з\'єднання',
          security: 'Безпека',
          personal: 'Особиста / WPA-PSK',
          enterprise: 'Корпоративна / 802.1X',
          identity: 'Ідентифікатор / Ім\'я користувача',
          authentication: 'Аутентифікація',
          innerAuthentication: 'Внутрішня аутентифікація',
          anonymousIdentity: 'Анонімний ідентифікатор (необов\'язково)',
          caCert: 'Шлях до сертифіката CA (необов\'язково)',
          domainSuffixMatch: 'Збіг суфіксу домену (необов\'язково)',
          clientCert: 'Шлях до сертифіката клієнта',
          privateKey: 'Шлях до приватного ключа',
          privateKeyPasswd: 'Пароль приватного ключа (необов\'язково)',
          eapPeap: 'Protected EAP (PEAP)',
          eapTtls: 'Tunneled TLS (TTLS)',
          eapTls: 'TLS (Сертифікат)',
          eapPwd: 'PWD',
          eapLeap: 'LEAP',
        ...
        ethernet: {
          title: 'Дротова мережа',
          description: 'Налаштування IP та опціональної аутентифікації 802.1X',
          connect: 'Налаштувати дротову мережу',
          connectDesc: 'Налаштувати IP для {{iface}} та увімкнути 802.1X за потреби',
          ipConfig: 'Налаштування IP',
          ipConfigDescription: 'Оберіть DHCP або встановіть статичну адресу для цього дротового інтерфейсу',
          authTitle: 'Аутентифікація 802.1X',
          authDescription: 'Увімкніть лише якщо ваша дротова мережа вимагає аутентифікацію за ім\'ям користувача, паролем або сертифікатом',
          driverRequired: 'Дротовий 802.1X потребує системний wpa_supplicant з підтримкою драйвера wired',
          addressPlaceholder: 'Статична IP-адреса (наприклад: 192.168.1.10)',
          gatewayPlaceholder: 'Шлюз (необов\'язково)',
          passwordUnchanged: 'Без змін',
          privateKeyPasswdUnchanged: 'Без змін',
          off: 'Вимкнено',
          enterprise: 'Корпоративна / 802.1X',
          active: '802.1X увімкнено',
          inactive: '802.1X налаштовано, очікування аутентифікації',
          failed: 'Помилка налаштування дротової мережі 802.1X. Спробуйте ще раз.'
        },

    ...
    settings: {
      ...
      network: {
        ...
        wifi: {
          ...
          ipConfigDescription: 'Välj DHCP eller ange en statisk adress för detta Wi-Fi-anslutning',
          security: 'Säkerhet',
          personal: 'Personlig / WPA-PSK',
          enterprise: 'Företag / 802.1X',
          identity: 'Identitet / Användarnamn',
          authentication: 'Autentisering',
          innerAuthentication: 'Inre autentisering',
          anonymousIdentity: 'Anonym identitet (valfritt)',
          caCert: 'CA-certifikatsökväg (valfritt)',
          domainSuffixMatch: 'Domänuffix-matchning (valfritt)',
          clientCert: 'Klientcertifikatsökväg',
          privateKey: 'Privat nyckelsökväg',
          privateKeyPasswd: 'Lösenord för privat nyckel (valfritt)',
        ...
        ethernet: {
          title: 'Trådbundet nätverk',
          description: 'Konfigurera IP-inställningar och valfri 802.1X-autentisering',
          connect: 'Konfigurera trådbundet nätverk',
          connectDesc: 'Konfigurera IP för {{iface}} och aktivera 802.1X vid behov',
          ipConfig: 'IP-konfiguration',
          ipConfigDescription: 'Välj DHCP eller ange en statisk adress för detta trådbundna gränssnitt',
          authTitle: '802.1X-autentisering',
          authDescription: 'Aktivera endast om ditt trådbundna nätverk kräver användarnamn, lösenord eller certifikat-autentisering',
          driverRequired: 'Trådbundet 802.1X kräver en system-wpa_supplicant med stöd för wired-drivrutin',
          addressPlaceholder: 'Statisk IP-adress (t.ex. 192.168.1.10)',
          gatewayPlaceholder: 'Gateway (valfritt)',
          passwordUnchanged: 'Ingen ändring',
          privateKeyPasswdUnchanged: 'Ingen ändring',
          off: 'Inaktiverad',
          enterprise: 'Företag / 802.1X',
          active: '802.1X aktiverad',
          inactive: '802.1X konfigurerad, väntar på autentisering',
          failed: 'Misslyckades med att konfigurera trådbundet nätverk 802.1X. Försök igen.'
        },
        ...
        dns: {
          ...
          rxRate: 'Mottagningshastighet',
          txRate: 'Sändningshastighet',
          none: 'Ingen'
        },

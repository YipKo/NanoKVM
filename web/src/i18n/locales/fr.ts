    ...
    settings: {
      ...
      network: {
        ...
        wifi: {
          ...
          ipConfigDescription: 'Choisir DHCP ou définir une adresse statique pour cette connexion Wi-Fi',
          security: 'Sécurité',
          personal: 'Personnel / WPA-PSK',
          enterprise: 'Entreprise / 802.1X',
          identity: 'Identifiant / Nom d\'utilisateur',
          authentication: 'Authentification',
          innerAuthentication: 'Authentification interne',
          anonymousIdentity: 'Identité anonyme (optionnel)',
          caCert: 'Chemin du certificat CA (optionnel)',
          domainSuffixMatch: 'Correspondance du suffixe de domaine (optionnel)',
          clientCert: 'Chemin du certificat client',
          privateKey: 'Chemin de la clé privée',
          privateKeyPasswd: 'Mot de passe de la clé privée (optionnel)',
          eapPeap: 'Protected EAP (PEAP)',
          eapTtls: 'Tunneled TLS (TTLS)',
          eapTls: 'TLS (Certificat)',
          eapPwd: 'PWD',
          eapLeap: 'LEAP',
        ...
        ethernet: {
          title: 'Réseau filaire',
          description: 'Configurer les paramètres IP et l\'authentification 802.1X optionnelle',
          connect: 'Configurer le réseau filaire',
          connectDesc: 'Configurer les paramètres IP pour {{iface}} et activer 802.1X si nécessaire',
          ipConfig: 'Configuration IP',
          ipConfigDescription: 'Choisir DHCP ou définir une adresse statique pour cette interface filaire',
          authTitle: 'Authentification 802.1X',
          authDescription: 'Activez uniquement si votre réseau filaire nécessite une authentification par nom d\'utilisateur, mot de passe ou certificat',
          driverRequired: 'Le réseau filaire 802.1X nécessite un système wpa_supplicant avec prise en charge du pilote wired',
          addressPlaceholder: 'Adresse IP statique (ex: 192.168.1.10)',
          gatewayPlaceholder: 'Passerelle (optionnel)',
          passwordUnchanged: 'Aucun changement',
          privateKeyPasswdUnchanged: 'Aucun changement',
          off: 'Désactivé',
          enterprise: 'Entreprise / 802.1X',
          active: '802.1X activé',
          inactive: '802.1X configuré, en attente d\'authentification',
          failed: 'Échec de la configuration du réseau filaire 802.1X. Veuillez réessayer.'
        },

    ...
    settings: {
      ...
      network: {
        ...
        wifi: {
          ...
          ipConfigDescription: 'Vyberte DHCP nebo nastavte statickou adresu pro toto připojení Wi-Fi',
          security: 'Zabezpečení',
          personal: 'Osobní / WPA-PSK',
          enterprise: 'Firemní / 802.1X',
          identity: 'Identita / Uživatelské jméno',
          authentication: 'Ověření',
          innerAuthentication: 'Vnitřní ověření',
          anonymousIdentity: 'Anonymní identita (volitelné)',
          caCert: 'Cesta k certifikátu CA (volitelné)',
          domainSuffixMatch: 'Shoda přípony domény (volitelné)',
          clientCert: 'Cesta klientského certifikátu',
          privateKey: 'Cesta soukromého klíče',
          privateKeyPasswd: 'Heslo soukromého klíče (volitelné)',
          eapPeap: 'Protected EAP (PEAP)',
          eapTtls: 'Tunneled TLS (TTLS)',
          eapTls: 'TLS (Certifikát)',
          eapPwd: 'PWD',
          eapLeap: 'LEAP',
        ...
        ethernet: {
          title: 'Drátová síť',
          description: 'Konfigurace IP a volitelného ověření 802.1X',
          connect: 'Nakonfigurovat drátovou síť',
          connectDesc: 'Nakonfigurujte IP pro {{iface}} a povolte 802.1X v případě potřeby',
          ipConfig: 'Konfigurace IP',
          ipConfigDescription: 'Vyberte DHCP nebo nastavte statickou adresu pro tento drátový interface',
          authTitle: 'Ověření 802.1X',
          authDescription: 'Povolte pouze pokud vaše drátová síť vyžaduje ověření pomocí uživatelského jména, hesla nebo certifikátu',
          driverRequired: 'Drátové 802.1X vyžaduje systémový wpa_supplicant s podporou ovladače wired',
          addressPlaceholder: 'Statická IP adresa (např. 192.168.1.10)',
          gatewayPlaceholder: 'Brána (volitelné)',
          passwordUnchanged: 'Beze změny',
          privateKeyPasswdUnchanged: 'Beze změny',
          off: 'Zakázáno',
          enterprise: 'Firemní / 802.1X',
          active: '802.1X povoleno',
          inactive: '802.1X nakonfigurováno, čeká na ověření',
          failed: 'Nepodařilo se nakonfigurovat drátovou síť 802.1X. Zkuste to prosím znovu.'
        },

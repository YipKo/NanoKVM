    ...
    settings: {
      ...
      network: {
        ...
        wifi: {
          ...
          ipConfigDescription: 'DHCP oder statische Adresse für diese Wi-Fi-Verbindung wählen',
          security: 'Sicherheit',
          personal: 'Persönlich / WPA-PSK',
          enterprise: 'Unternehmen / 802.1X',
          identity: 'Identität / Benutzername',
          authentication: 'Authentifizierung',
          innerAuthentication: 'Innere Authentifizierung',
          anonymousIdentity: 'Anonyme Identität (optional)',
          caCert: 'CA-Zertifikatpfad (optional)',
          domainSuffixMatch: 'Domänensuffix-Abgleich (optional)',
          clientCert: 'Client-Zertifikatpfad',
          privateKey: 'Privater Schlüsselpfad',
          privateKeyPasswd: 'Passwort für privaten Schlüssel (optional)',
          eapPeap: 'Protected EAP (PEAP)',
          eapTtls: 'Tunneled TLS (TTLS)',
          eapTls: 'TLS (Zertifikat)',
          eapPwd: 'PWD',
          eapLeap: 'LEAP',
        ...
        ethernet: {
          title: 'Kabelgebundenes Netzwerk',
          description: 'IP-Einstellungen und optionale 802.1X-Authentifizierung konfigurieren',
          connect: 'Kabelgebundenes Netzwerk konfigurieren',
          connectDesc: 'IP-Konfiguration für {{iface}} festlegen und bei Bedarf 802.1X aktivieren',
          ipConfig: 'IP-Konfiguration',
          ipConfigDescription: 'DHCP oder statische Adresse für diese kabelgebundene Schnittstelle wählen',
          authTitle: '802.1X-Authentifizierung',
          authDescription: 'Nur aktivieren, wenn Ihr kabelgebundenes Netzwerk Benutzername, Passwort oder Zertifikat-Authentifizierung erfordert',
          driverRequired: 'Kabelgebundenes 802.1X erfordert ein wpa_supplicant-System mit Wired-Treiber-Unterstützung',
          addressPlaceholder: 'Statische IP-Adresse (z.B. 192.168.1.10)',
          gatewayPlaceholder: 'Gateway (optional)',
          passwordUnchanged: 'Keine Änderung',
          privateKeyPasswdUnchanged: 'Keine Änderung',
          off: 'Deaktiviert',
          enterprise: 'Unternehmen / 802.1X',
          active: '802.1X aktiviert',
          inactive: '802.1X konfiguriert, warte auf Authentifizierung',
          failed: 'Konfiguration von Kabelgebundenes Netzwerk 802.1X fehlgeschlagen. Bitte erneut versuchen.'
        },

    ...
    settings: {
      ...
      network: {
        ...
        wifi: {
          ...
          ipConfigDescription: 'Trieu DHCP o establiu una adreça estàtica per a aquesta connexió Wi-Fi',
          security: 'Seguretat',
          personal: 'Personal / WPA-PSK',
          enterprise: 'Empresa / 802.1X',
          identity: 'Identitat / Nom d\'usuari',
          authentication: 'Autenticació',
          innerAuthentication: 'Autenticació interna',
          anonymousIdentity: 'Identitat anònima (opcional)',
          caCert: 'Ruta del certificat CA (opcional)',
          domainSuffixMatch: 'Coincidència de sufix de domini (opcional)',
          clientCert: 'Ruta del certificat client',
          privateKey: 'Ruta de la clau privada',
          privateKeyPasswd: 'Contrasenya de la clau privada (opcional)',
        ...
        ethernet: {
          title: 'Xarxa amb cable',
          description: 'Configurar IP i autenticació 802.1X opcional',
          connect: 'Configurar xarxa amb cable',
          connectDesc: 'Configurar IP per a {{iface}} i activar 802.1X si cal',
          ipConfig: 'Configuració IP',
          ipConfigDescription: 'Trieu DHCP o establiu una adreça estàtica per a aquesta interfície amb cable',
          authTitle: 'Autenticació 802.1X',
          authDescription: 'Activeu només si la vostra xarxa amb cable requereix autenticació per nom d\'usuari, contrasenya o certificat',
          driverRequired: '802.1X amb cable necessita un wpa_supplicant del sistema amb suport de controlador wired',
          addressPlaceholder: 'Adreça IP estàtica (ex: 192.168.1.10)',
          gatewayPlaceholder: 'Passarel·la (opcional)',
          passwordUnchanged: 'Sense canvis',
          privateKeyPasswdUnchanged: 'Sense canvis',
          off: 'Desactivat',
          enterprise: 'Empresa / 802.1X',
          active: '802.1X activat',
          inactive: '802.1X configurat, esperant autenticació',
          failed: 'Error en configurar la xarxa amb cable 802.1X. Torneu-ho a provar.'
        },

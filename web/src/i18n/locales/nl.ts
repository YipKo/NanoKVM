    ...
    settings: {
      ...
      network: {
        ...
        wifi: {
          ...
          confirmBtn: 'OK',
          cancelBtn: 'Annuleren',
          ipConfig: 'IP-configuratie',
          ipConfigDescription: 'Kies DHCP of stel een statisch adres in voor deze Wi-Fi verbinding',
          security: 'Beveiliging',
          personal: 'Persoonlijk / WPA-PSK',
          enterprise: 'Zakelijk / 802.1X',
          identity: 'Identiteit / Gebruikersnaam',
          authentication: 'Authenticatie',
          innerAuthentication: 'Interne authenticatie',
          anonymousIdentity: 'Anonieme identiteit (optioneel)',
          caCert: 'CA-certificaatpad (optioneel)',
          domainSuffixMatch: 'Domeinsuffix-overeenkomst (optioneel)',
          clientCert: 'Clientcertificaatpad',
          privateKey: 'Privésleutelpad',
          privateKeyPasswd: 'Privésleutelwachtwoord (optioneel)',
          eapPeap: 'Protected EAP (PEAP)',
          eapTtls: 'Tunneled TLS (TTLS)',
          eapTls: 'TLS (Certificaat)',
          eapPwd: 'PWD',
          eapLeap: 'LEAP',
        ...
        ethernet: {
          title: 'Bekabeld netwerk',
          description: 'IP-instellingen en optionele 802.1X-authenticatie configureren',
          connect: 'Bekabeld netwerk configureren',
          connectDesc: 'IP-configuratie voor {{iface}} instellen en 802.1X inschakelen indien nodig',
          ipConfig: 'IP-configuratie',
          ipConfigDescription: 'Kies DHCP of stel een statisch adres in voor deze bekabelde interface',
          authTitle: '802.1X-authenticatie',
          authDescription: 'Alleen inschakelen als uw bekabelde netwerk gebruikersnaam, wachtwoord of certificaat-authenticatie vereist',
          driverRequired: 'Bekabeld 802.1X vereist een systeem wpa_supplicant build met wired driver ondersteuning',
          addressPlaceholder: 'Statisch IP-adres (bijv. 192.168.1.10)',
          gatewayPlaceholder: 'Gateway (optioneel)',
          passwordUnchanged: 'Geen wijziging',
          privateKeyPasswdUnchanged: 'Geen wijziging',
          off: 'Uitgeschakeld',
          enterprise: 'Zakelijk / 802.1X',
          active: '802.1X ingeschakeld',
          inactive: '802.1X geconfigureerd, wacht op authenticatie',
          failed: 'Configuratie van bekabeld netwerk 802.1X mislukt. Probeer het opnieuw.'
        },

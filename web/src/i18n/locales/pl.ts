    ...
    settings: {
      ...
      network: {
        ...
        wifi: {
          ...
          ipConfigDescription: 'Wybierz DHCP lub ustaw statyczny adres dla tego połączenia Wi-Fi',
          security: 'Bezpieczeństwo',
          personal: 'Osobiste / WPA-PSK',
          enterprise: 'Firmowe / 802.1X',
          identity: 'Tożsamość / Nazwa użytkownika',
          authentication: 'Uwierzytelnianie',
          innerAuthentication: 'Uwierzytelnianie wewnętrzne',
          anonymousIdentity: 'Anonimowa tożsamość (opcjonalnie)',
          caCert: 'Ścieżka certyfikatu CA (opcjonalnie)',
          domainSuffixMatch: 'Dopasowanie sufiksu domeny (opcjonalnie)',
          clientCert: 'Ścieżka certyfikatu klienta',
          privateKey: 'Ścieżka klucza prywatnego',
          privateKeyPasswd: 'Hasło klucza prywatnego (opcjonalnie)',
          eapPeap: 'Protected EAP (PEAP)',
          eapTtls: 'Tunneled TLS (TTLS)',
          eapTls: 'TLS (Certyfikat)',
          eapPwd: 'PWD',
          eapLeap: 'LEAP',
        ...
        ethernet: {
          title: 'Sieć przewodowa',
          description: 'Konfiguracja IP i opcjonalnego uwierzytelniania 802.1X',
          connect: 'Skonfiguruj sieć przewodową',
          connectDesc: 'Skonfiguruj IP dla {{iface}} i włącz 802.1X jeśli potrzeba',
          ipConfig: 'Konfiguracja IP',
          ipConfigDescription: 'Wybierz DHCP lub ustaw statyczny adres dla tego interfejsu przewodowego',
          authTitle: 'Uwierzytelnianie 802.1X',
          authDescription: 'Włącz tylko jeśli sieć przewodowa wymaga uwierzytelnienia nazwą użytkownika, hasłem lub certyfikatem',
          driverRequired: 'Przewodowe 802.1X wymaga systemowego wpa_supplicant z obsługą sterownika wired',
          addressPlaceholder: 'Statyczny adres IP (np. 192.168.1.10)',
          gatewayPlaceholder: 'Brama (opcjonalnie)',
          passwordUnchanged: 'Bez zmian',
          privateKeyPasswdUnchanged: 'Bez zmian',
          off: 'Wyłączone',
          enterprise: 'Firmowe / 802.1X',
          active: '802.1X włączone',
          inactive: '802.1X skonfigurowane, oczekiwanie na uwierzytelnienie',
          failed: 'Nie udało się skonfigurować sieci przewodowej 802.1X. Spróbuj ponownie.'
        },

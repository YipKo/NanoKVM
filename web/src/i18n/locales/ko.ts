    ...
    settings: {
      ...
      network: {
        ...
        wifi: {
          ...
          cancelBtn: '취소',
          ipConfig: 'IP 설정',
          ipConfigDescription: '이 Wi-Fi 연결에 DHCP 또는 고정 주소 설정',
          security: '보안',
          personal: '개인 / WPA-PSK',
          enterprise: '기업 / 802.1X',
          identity: 'ID / 사용자 이름',
          authentication: '인증 방식',
          innerAuthentication: '내부 인증',
          anonymousIdentity: '익명 ID (선택)',
          caCert: 'CA 인증서 경로 (선택)',
          domainSuffixMatch: '도메인 접미사 일치 (선택)',
          clientCert: '클라이언트 인증서 경로',
          privateKey: '개인키 경로',
          privateKeyPasswd: '개인키 비밀번호 (선택)',
        ...
        ethernet: {
          title: '유선 네트워크',
          description: 'IP 설정 및 선택적 802.1X 인증 구성',
          connect: '유선 네트워크 설정',
          connectDesc: '{{iface}}의 IP 설정을 구성하고 필요시 802.1X 인증 활성화',
          ipConfig: 'IP 설정',
          ipConfigDescription: '이 유선 인터페이스에 DHCP 또는 고정 주소 설정',
          authTitle: '802.1X 인증',
          authDescription: '유선 네트워크에서 사용자 이름, 비밀번호 또는 인증서 인증이 필요한 경우에만 활성화하세요',
          driverRequired: '유선 802.1X에는 wired 드라이버를 지원하는 wpa_supplicant 시스템 빌드가 필요합니다',
          addressPlaceholder: '고정 IP 주소 (예: 192.168.1.10)',
          gatewayPlaceholder: '게이트웨이 (선택)',
          passwordUnchanged: '변경 없음',
          privateKeyPasswdUnchanged: '변경 없음',
          off: '비활성화',
          enterprise: '기업 / 802.1X',
          active: '802.1X 활성화됨',
          inactive: '802.1X 설정됨, 인증 대기 중',
          failed: '유선 네트워크 802.1X 설정에 실패했습니다. 다시 시도해 주세요.'
        },

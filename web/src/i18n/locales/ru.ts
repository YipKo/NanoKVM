    ...
    settings: {
      ...
      network: {
        ...
        wifi: {
          ...
          ipConfigDescription: 'Выберите DHCP или установите статический адрес для этого Wi-Fi подключения',
          security: 'Безопасность',
          personal: 'Личная / WPA-PSK',
          enterprise: 'Корпоративная / 802.1X',
          identity: 'Идентификатор / Имя пользователя',
          authentication: 'Аутентификация',
          innerAuthentication: 'Внутренняя аутентификация',
          anonymousIdentity: 'Анонимный идентификатор (необязательно)',
          caCert: 'Путь к сертификату CA (необязательно)',
          domainSuffixMatch: 'Совпадение суффикса домена (необязательно)',
          clientCert: 'Путь к клиентскому сертификату',
          privateKey: 'Путь к закрытому ключу',
          privateKeyPasswd: 'Пароль закрытого ключа (необязательно)',
          eapPeap: 'Protected EAP (PEAP)',
          eapTtls: 'Tunneled TLS (TTLS)',
          eapTls: 'TLS (Сертификат)',
          eapPwd: 'PWD',
          eapLeap: 'LEAP',
        ...
        ethernet: {
          ...
          description: 'Настройка IP и опциональной аутентификации 802.1X',
          connect: 'Настроить проводную сеть',
          connectDesc: 'Настроить IP для {{iface}} и включить 802.1X при необходимости',
          ipConfig: 'Настройка IP',
          ipConfigDescription: 'Выберите DHCP или установите статический адрес для этого проводного интерфейса',
          authTitle: 'Аутентификация 802.1X',
          authDescription: 'Включите только если ваша проводная сеть требует аутентификацию по имени пользователя, паролю или сертификату',
          driverRequired: 'Проводной 802.1X требует системный wpa_supplicant с поддержкой драйвера wired',
          addressPlaceholder: 'Статический IP-адрес (например: 192.168.1.10)',
          gatewayPlaceholder: 'Шлюз (необязательно)',
          passwordUnchanged: 'Без изменений',
          privateKeyPasswdUnchanged: 'Без изменений',
          off: 'Отключено',
          enterprise: 'Корпоративная / 802.1X',
          active: '802.1X включён',
          inactive: '802.1X настроен, ожидание аутентификации',
          failed: 'Ошибка настройки проводной сети 802.1X. Пожалуйста, попробуйте снова.'
        },
